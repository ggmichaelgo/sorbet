...
TEST_CASE("PerPhaseTest") { // NOLINT
    ...
    UnorderedSet<core::FileRef> stressedFiles;
    for (auto &f : trees) {
        stressedFiles.emplace(f.file);
    }
    sorbet::pipeline::definition_checker::checkNoDefinitionsInsideProhibitedLines(*gs, stressedFiles);
